...
class TRenderer(unittest.TestCase):
    ...
    def test_26_point_observable(self):
        segs = [
            {"start_ms": 0, "end_ms": 180, "pose": "idle", "viseme": "REST"},
            {"start_ms": 180, "end_ms": 500, "pose": "point", "viseme": "REST"},
            {"start_ms": 500, "end_ms": 1000, "pose": "point", "viseme": "REST"},
            {"start_ms": 1000, "end_ms": 1260, "pose": "idle", "viseme": "REST"},
        ]
        a = render_frame(_BUNDLE, 500, 700, 0, _chars(_tl(dur=1260, segs=segs)))
        b = render_frame(_BUNDLE, 500, 700, 300, _chars(_tl(dur=1260, segs=segs)))
        self.assertNotEqual(a, b)
